...
show_deployment_summary() {
    ...
    echo -e "  • GitHub Repository: ${CYAN}https://github.com/caovinhphuc/mia-vn-google-integration-v1.0${NC}"
    echo ""
...
case "${1:-}" in
    --help|-h)
        ...
        ;;
    --version|-v)
        echo "MIA.vn Google Integration - Vercel Deployment Script v1.0.1"
        exit 0
        ;;
esac
